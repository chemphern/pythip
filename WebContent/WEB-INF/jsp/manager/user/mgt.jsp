...
<link rel="stylesheet" href="${cssres }/common/manager.css" />
<link rel="stylesheet" href="${cssres }/date/WdatePicker.css" />
<title>人事管理系统</title>
</head>
<body>
...
<script type="text/javascript" src="${jsres }/jquery/plugin/date/WdatePicker.js"></script>
<script type="text/javascript" src="${jsres }/jquery/plugin/jquery.pagination.js"></script>
